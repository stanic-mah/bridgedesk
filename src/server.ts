...
const WORKSPACE_APP_URI = "ui://bridgedesk/workspace-app.html";
...
<html lang="en">
  <head>
    ...
    <title>BridgeDesk Workspace</title>
...
function createMcpServer(
  ...
  registerAppResource(
    server,
    "BridgeDesk Diff Card",
    WORKSPACE_APP_URI,
    {
      description: "Interactive card for viewing BridgeDesk file diffs.",
      _meta: {
        ui: {
          csp: appCsp(config),
        },
...
export function createServer(config = loadConfig()): RunningServer {
  ...
  app.get("/healthz", (_req, res) => {
    res.json({ ok: true, name: "bridgedesk" });
  });
